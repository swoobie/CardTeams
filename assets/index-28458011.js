...
const Header_vue_vue_type_style_index_0_scoped_bedb9f68_lang = "";
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-bedb9f68"]]);
const _sfc_main$4 = {
  __name: "App",
  setup(__props) {
    return (_ctx, _cache) => {
...
const router = createRouter({
  history: createWebHistory("/CardTeams/"),
  routes: [
    {
      path: "/",
      name: "home",
